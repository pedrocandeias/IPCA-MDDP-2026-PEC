...
A antropometria aplicada ao design protésico evoluiu para um paradigma digital centrado na captura e na interpretação tridimensionais, complementado por métricas de interface que aproximam a medição do desempenho real de uso. Esta abordagem permite maior precisão na personalização, na integração com CAD e na parametrização, bem como na fabricação aditiva, e abre caminho para fluxos de adaptação parcialmente automatizados.Contudo, a consolidação destas práticas exige a melhoria da padronização dos procedimentos, o aumento do número de amostras e a criação de bases de dados antropométricas mais representativas, garantindo que a personalização e a inclusão não dependam apenas da capacidade tecnológica, mas também de evidências robustas e acessíveis ([Bradtmiller, 2022](#ref-bradtmiller-2022); [Sunderland et al., 2024](#ref-sunderland-2024)).

No contexto desta investigação, esta necessidade de estruturação de dados foi operacionalizada através da criação de uma base local consolidada de medidas antropométricas da %% registada no ficheiro material/antropometria/dados antropométricos/multipopulationhand.csv %%. Os dados coleactados funciona como base intermédia para a comparação entre amostras, a seleção de parâmetros dimensionais e o teste de coerência geométrica no desenvolvimento do modelo paramétrico, preservando, para cada entrada, a proveniência bibliográfica, a medida recolhida, o grupo populacional, o tipo de estatística descrita e os valores convertidos para unidades comparáveis. Um primeiro núcleo desta consolidação, sintetizado no quadro seguinte, reuniu cinco estudos com populações do México, Índia, Turquia, Portugal e Nigéria e serviu de base para a organização do conjunto de dados ([Anacleto Filho et al., 2023](#ref-anacleto-filho-2023); [Chatzioglou et al., 2024](#ref-chatzioglou-2024); [Ibiwari et al., 2025](#ref-ibiwari-2025); [Nag et al., 2003](#ref-nag-2003); [Rodríguez-Vega & Rodríguez-Vega, 2024](#ref-rodriguez-vega-2024)).
...
| Turquia  | [Chatzioglou et al. (2024)](#ref-chatzioglou-2024)       | 51          | 5 comprimentos dos dedos da mão direita, por sexo e combinado                                                              | 56  |
| -------- | -------------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------- | --- |
...
| Índia    | [Nag et al. (2003)](#ref-nag-2003)                       | 95 mulheres | 51 dimensões, incluindo comprimentos, larguras, circunferências, profundidades e aberturas, com P5/P50/P95                 | 255 |
| Portugal | [Anacleto Filho et al. (2023)](#ref-anacleto-filho-2023) | 343         | Comprimento e largura da mão, com P5/P50/P95                                                                               | 20  |
| Nigéria  | [Ibiwari et al. (2025)](#ref-ibiwari-2025)               | 80 atletas  | Comprimento da mão, largura da mão, comprimento palmar e 3.º dedo, com subgrupos de basquetebol e voleibol                 | 32  |

Fonte: elaboração própria, com base em [Anacleto Filho et al. (2023)](#ref-anacleto-filho-2023), [Chatzioglou et al. (2024)](#ref-chatzioglou-2024), [Ibiwari et al. (2025)](#ref-ibiwari-2025), [Nag et al. (2003)](#ref-nag-2003) e [Rodríguez-Vega e Rodríguez-Vega (2024)](#ref-rodriguez-vega-2024).
