...
TOKEN_REPLACEMENTS = (
    ...
    ("anexos/dados_antropometricos_v14.67.0/", "material suplementar da dissertação"),
    ("anexos/dicionario_parametros_v14.67.0/example_flexy_beast_child_8/", "material suplementar associado ao Anexo C"),
    ("anexos/dicionario_parametros_v14.67.0/parameter_dictionary.csv", "dicionário integral no material suplementar do Anexo C"),
    ("anexos/dicionario_parametros_v14.67.0/", "material suplementar associado ao Anexo C"),
    ("anexos/testes_plataforma/evidencias/", "material suplementar associado ao Anexo B"),
...
PARAGRAPH_REPLACEMENTS = {
    ...
    "Os ficheiros params.json, palm.3mf, middle_base.3mf, middle_tip.3mf e trace.json, os respectivos valores SHA-256 e o dicionário completo encontram-se em anexos/dicionario_parametros_v14.67.0/. O percurso é reproduzível ao nível do artefacto arquivado e do cálculo; permanece uma verificação técnica com perfil simulado, sem avaliação de conforto, função, segurança ou validade clínica.":
