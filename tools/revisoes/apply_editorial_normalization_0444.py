...
TOKEN_REPLACEMENTS = (
    ...
    ("docs/revisoes/manuscrito/relatorio-revisao-academica-integral-dissertacao-2026-07-13.md", "relatório integral de revisão académica"),
...
PARAGRAPH_REPLACEMENTS = {
    ...
    "Fonte: elaboração própria a partir dos prompts registados em docs/desenvolvimento/avaliacao_ia/ai_anthropometric_validation.md, dos metadados em docs/desenvolvimento/avaliacao_ia/flexy-beast-ai-sim/run-metadata.json, docs/desenvolvimento/avaliacao_ia/paraglider-ai-sim/run-metadata.json e docs/desenvolvimento/avaliacao_ia/phoenix-ai-sim/run-metadata.json, e dos cenários em docs/desenvolvimento/avaliacao_ia/ucd-ai-sim/. A coluna apresenta a descrição do caso simulado enviada no pedido; o pedido completo incluía o esquema actual do modelo, os intervalos permitidos e a instrução de devolver apenas JSON válido.":
