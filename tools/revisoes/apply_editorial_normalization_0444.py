...
TOKEN_REPLACEMENTS = (
    ...
    ("sources/manuscript/annexes/dados_antropometricos_v14.67.0/", "material suplementar da dissertação"),
    ("sources/manuscript/annexes/dicionario_parametros_v14.67.0/example_flexy_beast_child_8/", "material suplementar associado ao Anexo C"),
    ("sources/manuscript/annexes/dicionario_parametros_v14.67.0/parameter_dictionary.csv", "dicionário integral no material suplementar do Anexo C"),
    ("sources/manuscript/annexes/dicionario_parametros_v14.67.0/", "material suplementar associado ao Anexo C"),
    ("sources/manuscript/annexes/testes_plataforma/evidencias/", "material suplementar associado ao Anexo B"),
