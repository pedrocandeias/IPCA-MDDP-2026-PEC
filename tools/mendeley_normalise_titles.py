...
Uso:
    ...
    mendeley_normalise_titles.py --only-cited    # só registos citados no MD
"""
...
MD = REPO_ROOT / "pedro-candeias-projeto-mestrado-mdddp-ipca-2026-revisto.md"
