...
- `material/bibliografia/`: cache bibliográfica específica do manuscrito e controlo de PDFs em falta
...
extração e apoio à organização de componentes/figuras/tabelas
...
O diretório [material/bibliografia](/home/pec/dev/mestrado/material/bibliografia) serve para manter lado a lado:
...
O ficheiro [material/bibliografia/pdfs_em_falta.md](/home/pec/dev/mestrado/material/bibliografia/pdfs_em_falta.md) é o registo autoritativo das referências do manuscrito que ainda não têm PDF localizado em `material/` ou em `material/bibliografia/`.

## Workflow recomendado

1. Trabalhar o texto em `Projecto completo.md` 2. Criar backup em `versions/` antes de revisões substantivas 3. Fazer pesquisa dirigida em `sources/elicit/` 4. Descarregar reports e guardar notas locais 5. Integrar incrementalmente no manuscrito 6. Atualizar a bibliografia final em `Projecto completo.md` 7. Copiar PDFs citados para `material/bibliografia/` 8. Atualizar `material/bibliografia/pdfs_em_falta.md` 9. Registar tudo no `CHANGELOG.md`
