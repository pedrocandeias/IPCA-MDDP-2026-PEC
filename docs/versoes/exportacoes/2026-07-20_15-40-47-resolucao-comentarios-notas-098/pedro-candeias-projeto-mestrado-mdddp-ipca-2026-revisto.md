...
| Tabela 2.2 | Elementos centrais na configuração da participação em sistemas configuráveis | 31 |
...
| Tabela 6.1 | Especificação técnica dos modelos de IA e da estrutura da sugestão paramétrica | 89 |
| Tabela 6.2 | Distribuição de tarefas entre regras, IA e supervisão humana | 91 |
| Tabela 8.1 | Evidência do funcionamento da plataforma no processo de projecto | 98 |
| Tabela 8.2 | Projectos de preparação digital para impressão 3D com configuração analisada | 101 |
| Tabela 8.3 | Inspecção computacional das malhas geradas para um perfil antropométrico de 8 anos | 103 |
| Tabela 8.4 | Descrições submetidas nos cenários de avaliação da IA | 107 |
| Tabela 8.5 | Síntese da avaliação das sugestões de IA | 108 |
| Tabela 8.6 | Modelos e mecanismos de escala avaliados | 110 |
| Tabela 8.7 | Factor de escala da maior dimensão da palma exportada relativamente à configuração de referência | 110 |
| Tabela 8.8 | Discussão dos resultados face às lacunas seleccionadas do estado da arte | 112 |
| Tabela 9.1 | Estado da resposta às perguntas de investigação aprovadas | 115 |
...
| Figura 6.1 | Relação entre desafios de compreensão das decisões e princípios de IA responsável. | 93 |
| Figura 7.1 | Exemplo publicado de teste de uma prótese impressa em 3D com um utilizador; esta actividade não integrou a avaliação da presente dissertação. | 96 |
| Figura 8.1 | Componentes impressos e estados preliminares de montagem: segmentos digitais articulados, palma e elementos separados. | 104 |
| Figura 8.2 | Séries físicas de segmentos identificados pelos perfis de ensaio de 8, 15, 28 e 70 anos. | 104 |
| Figura 8.3 | UnLimbited Phoenix configurada para o perfil de ensaio de 15 anos, apresentada em sete vistas da montagem física. | 105 |
| Figura 8.4 | Tarefas funcionais usadas em avaliação de prótese personalizada de membro superior. | 106 |
| Figura C.1 | Fluxo entre dados de entrada, mapa comum, regras específicas dos modelos e geometria exportável. Produção própria. | 160 |
...
| Identificação | Descrição | Página |
| --- | --- | --- |
| Tabela B.1 | Resultados da repetição da mesma configuração por modelo | 151 |
| Tabela B.2 | Resultados do percurso examinado em três navegadores | 151 |
| Tabela B.3 | Comportamento observado perante limites, entradas inválidas e falhas previstas | 152 |
| Tabela B.4 | Categorias de problemas de acessibilidade digital detectadas automaticamente | 154 |
| Tabela B.5 | Resultados da verificação manual complementar de acessibilidade | 154 |
...
| Identificação | Descrição | Página |
| --- | --- | --- |
| Tabela C.1 | Correspondência entre medidas normalizadas e parâmetros dos modelos | 160 |
| Tabela C.2 | Parâmetros numéricos do Flexy Beast com efeito dimensional | 162 |
| Tabela C.3 | Relações dimensionais do Paraglider Hand | 168 |
| Tabela C.4 | Comparação das adaptações e excepções de escala | 173 |
...
| Identificação | Descrição | Página |
| --- | --- | --- |
| Tabela D.1 | Estimativas dos projectos de preparação digital para impressão 3D com configuração analisada | 180 |
| Tabela D.2 | Estimativas de preparação para impressão na condição digital comum | 181 |
| Tabela D.3 | Comparação dimensional da palma no eixo X em PLA e PETG | 183 |
