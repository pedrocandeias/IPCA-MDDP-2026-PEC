...
| Tabela B.1 | Resultados da repetição da mesma configuração por modelo | 125 |
| Tabela B.2 | Resultados do percurso examinado em três navegadores | 125 |
| Tabela B.3 | Comportamento observado perante limites, entradas inválidas e falhas previstas | 126 |
| Tabela B.4 | Categorias de problemas de acessibilidade digital detectadas automaticamente | 127 |
| Tabela B.5 | Identificação das campanhas complementares de avaliação da plataforma | 128 |
| Tabela C.1 | Correspondência entre medidas normalizadas e parâmetros dos modelos | 131 |
| Tabela C.2 | Parâmetros numéricos do Flexy Beast com efeito dimensional | 133 |
| Tabela C.3 | Relações dimensionais do Paraglider Hand | 136 |
| Tabela C.4 | Comparação das adaptações e excepções de escala | 140 |
...
| Figura C.1 | Fluxo entre dados de entrada, mapa comum, regras específicas dos modelos e geometria exportável. Produção própria. | 131 |
