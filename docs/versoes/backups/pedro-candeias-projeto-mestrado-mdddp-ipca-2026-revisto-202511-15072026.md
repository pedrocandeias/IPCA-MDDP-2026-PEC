...
Os registos da IA correspondem a conjuntos finitos de execuções e a estados específicos do código. Não foi realizado um estudo estatístico com amostras extensas por cenário. O estado final da plataforma foi inspeccionada e os dez ensaios unitários disponíveis foram concluídos, mas a bateria completa no navegador não foi novamente executada no fecho da dissertação.
