...
| `[^2]` | Resolvida. | Secção 2.1, enquadramento regulatório: referência ao Regulamento (UE) 2017/745 relativo aos dispositivos médicos. | «Meter este link na bibliografia» | A entrada normativa completa foi integrada na bibliografia e o PDF oficial em português foi arquivado em `material/bibliografia/Regulamento_UE_2017_745_dispositivos_medicos_PT.pdf`. |
