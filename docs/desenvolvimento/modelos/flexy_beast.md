...
[`docs/desenvolvimento/avaliacao_ia/flexy-beast-ai-sim/`](../avaliacao_ia/flexy-beast-ai-sim/flexy-beast_ai-sizing-dimensional-report_2026-06-28.md).
...
described sex/age — see `docs/desenvolvimento/avaliacao_ia/ai_anthropometric_validation.md` §2.4. Flexy Beast is a
