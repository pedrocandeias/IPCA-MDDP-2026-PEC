...
> path can drop below 100%. See `docs/desenvolvimento/avaliacao_ia/phoenix-ai-sim/` §5.
...
[`docs/desenvolvimento/avaliacao_ia/phoenix-ai-sim/`](../avaliacao_ia/phoenix-ai-sim/unlimbited-phoenix-hand_ai-sizing-dimensional-report_2026-06-28.md).
