...
- ✅ **Lateralidade determinística (feito, v14.19.0).** A mão/lado (esquerda/direita) deixou de
  ...
  [`docs/desenvolvimento/avaliacao_ia/ucd-ai-sim/`](ucd-ai-sim/ucd-ai-sizing-evaluation_2026-06-29.md) §2c.
...
- **Re-validação com grounding:** re-executar a §4–§5 com o grounding por dataset (§2.4) ativado
  ...
  - ✅ **`findBestProfileMatch` validado (2026-06-28).** As simulações de browser end-to-end
    ...
    [`docs/desenvolvimento/avaliacao_ia/flexy-beast-ai-sim/`](flexy-beast-ai-sim/flexy-beast_ai-sizing-dimensional-report_2026-06-28.md)
    e [`docs/desenvolvimento/avaliacao_ia/paraglider-ai-sim/`](paraglider-ai-sim/paraglider-hand_ai-sizing-dimensional-report_2026-06-28.md).
