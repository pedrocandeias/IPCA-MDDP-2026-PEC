...
| Tabela 4.2 | Conjuntos mínimos de parâmetros por nível de amputação | 42 |
| Tabela 4.3 | Métodos de recolha de dados antropométricos e suas características | 44 |
| Tabela 4.4 | Funções e limites da base antropométrica na configuração | 45 |
| Tabela 4.5 | Estrutura hierárquica dos parâmetros no modelo paramétrico | 46 |
| Tabela 4.6 | Mapeamento entre parâmetros antropométricos e elementos do modelo | 48 |
| Tabela 4.7 | Estrutura técnica em camadas de um modelo paramétrico em OpenSCAD para próteses personalizadas | 50 |
| Tabela 4.8 | Síntese das relações implementadas e respectivas limitações | 52 |
| Tabela 4.9 | Dicionário operacional dos parâmetros numéricos dos modelos avaliados | 53 |
| Tabela 4.10 | Percurso numérico do vector antropométrico até às malhas do Flexy Beast | 54 |
| Tabela 4.11 | Cronologia das principais iterações paramétricas | 55 |
| Tabela 5.1 | Fluxo de dados e responsabilidades da plataforma | 59 |
| Tabela 5.2 | Inventário consolidado dos modelos no fecho do estudo | 68 |
| Tabela 6.1 | Especificação técnica dos modelos de IA e do contrato de sugestão paramétrica | 73 |
| Tabela 6.2 | Distribuição de tarefas entre regras, IA e supervisão humana | 76 |
| Tabela 8.1 | Evidência técnica do funcionamento da plataforma | 82 |
| Tabela 8.2 | Projectos de preparação para impressão arquivados | 84 |
| Tabela 8.3 | Inspecção computacional de malhas na configuração infantil | 86 |
| Tabela 8.4 | Entradas utilizadas nos cenários de avaliação da IA | 89 |
| Tabela 8.5 | Síntese da avaliação das sugestões de IA | 91 |
| Tabela 8.6 | Modelos e mecanismos de escala avaliados | 92 |
| Tabela 8.7 | Rácio adimensional da maior dimensão da palma exportada face ao valor de referência | 93 |
...
| Figura 4.1 | Parâmetros antropométricos utilizados na modelação paramétrica de dedos protésicos. | 41 |
| Figura 4.2 | Comparação entre o escalonamento uniforme e a modelação paramétrica de dedo protésico. | 44 |
| Figura 4.3 | Relação entre modelo paramétrico digital, prototipagem e verificação de um dedo protésico. | 49 |
| Figura 5.1 | Fluxo geral de produção personalizada de próteses a partir de plataforma web – Hand Fab | 57 |
| Figura 5.2 | Arquitectura da plataforma e fronteiras entre navegador, servidor, serviço externo de IA e preparação do fabrico. | 60 |
| Figura 5.3 | Sequência de dados e decisões desde o perfil ou descrição até à sugestão, confirmação, geração determinística e exportação. | 61 |
| Figura 5.4 | Fluxo geral de produção personalizada de próteses a partir de digitalização, CAD adaptativo e fabrico aditivo. | 62 |
| Figura 5.5 | Ferramenta paramétrica para configuração de ajudas técnicas com variação de dimensões, materiais e peso. | 66 |
| Figura 6.1 | Relação entre desafios de explicabilidade e princípios de IA responsável. | 77 |
| Figura 7.1 | Exemplo publicado de teste de uma prótese impressa em 3D com um utilizador; esta actividade não integrou a avaliação da presente dissertação. | 80 |
| Figura 8.1 | Segmentos do Flexy Beast produzidos e assentes na plataforma da Bambu Lab A1. | 88 |
| Figura 8.2 | Série física de segmentos Flexy Beast identificados pelas idades simuladas de 8, 15, 28 e 70 anos. A imagem permite comparar escala e conclusão das peças, sem constituir medição dimensional ou ensaio mecânico. | 88 |
| Figura 8.3 | Série física de segmentos Paraglider Hand identificados pelas idades simuladas de 8, 15, 28 e 70 anos. A imagem documenta a transição para peças físicas e não demonstra ajuste anatómico. | 88 |
| Figura 8.4 | Tarefas funcionais usadas em avaliação de prótese personalizada de membro superior. | 89 |
...
As relações gerais das Tabelas 4.5 e 4.6 foram concretizadas de forma diferente em cada família. A versão 14.67.0 corresponde ao fecho dos ensaios principais e ao dicionário suplementar arquivado. A versão 14.71.0 acrescenta adaptações posteriores, nomeadamente a braçadeira comum do Flexy Beast e relações mais completas do Cyborg Beast. Estas alterações são documentadas como evolução projectual e não são retroactivamente apresentadas como parte dos ensaios concluídos na versão 14.67.0. As fórmulas descrevem a implementação; não representam relações anatómicas universais.
