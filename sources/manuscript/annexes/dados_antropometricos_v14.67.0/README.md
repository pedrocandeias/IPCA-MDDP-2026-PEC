# Suplemento antropométrico da plataforma 14.67.0
...
O caminho local do repositório serve apenas para identificar a proveniência no ambiente de desenvolvimento; este directório é a cópia suplementar autocontida usada para a revisão da dissertação.
