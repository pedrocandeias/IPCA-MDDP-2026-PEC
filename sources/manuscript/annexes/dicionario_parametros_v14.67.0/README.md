...
Este suplemento preserva o dicionário completo dos parâmetros numéricos dos três modelos avaliados na dissertação — Flexy Beast, Paraglider Hand e UnLimbited Phoenix — e um percurso verificável entre um perfil simulado, os parâmetros aplicados, as relações OpenSCAD e três malhas 3MF exportadas.
...
- `example_flexy_beast_child_8/params.json`: perfil simulado e valores aplicados.
...
Os valores do exemplo resultam de um perfil simulado e de uma extracção de IA arquivada. O percurso prova que valores aceites pelo esquema produzem transformações identificáveis e malhas mensuráveis. Não demonstra ajuste anatómico, conforto, função, segurança ou validade clínica.
