...
| `tabela_estimativa_dimensional_teorica.csv` | Cenário teórico para as 36 extensões X/Y/Z, calculado com uma hipótese explícita de contracção linear uniforme de 0,30%; não contém medições físicas |
