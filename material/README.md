...
Open your terminal and navigate to the folder holding the scripts. In this repository they live in `tools/`:

```
cd /path/to/mestrado/tools
```
...
This script compares the DOIs in your library with the manuscript's bibliography and fills in the ones that are missing or wrong.

```
python mendeley_sync_dois.py
python mendeley_sync_dois.py --apply
```
